...
procedure TOKDlg.ProcessOK;                                                                 //
                                                                                            //
//////////////////////////////////////////////////////////////////////////////////          //
  function GetStatus(const Y, X: WORD): byte;                                   //          //
  var                                                                           //          //
    Stat: WORD;                                                                 //          //
  begin                                                                         //          //
    Result := 0;                                                                //          //
    ...
    with pStatistica^.Wafer do                                                  //          //
    begin                                                                       //          //
      Stat := Chip[Y, X].Status;                                                //          //
                                                                                //          //
      if Stat = TestsParams[TestsCB.ItemIndex].Status then                      //          //
        case Stat of                                                            //          //
          2000..3000: begin                                                     //          //
                        Result := 2;                                            //          //
                        Exit;                                                   //          //
      ...
      if Stat = 1 then                                                          //          //
      begin                                                                     //          //
        if Chip[Y,X].Value[TestsCB.ItemIndex] <> NotSpec then Result := 1;      //          //
        Exit;                                                                   //          //
      end;                                                                      //          //
                                                                                //          //
      case Stat of                                                              //          //
        2000..3000,                                                             //          //
        3500..4500:                                                             //          //
          with TestsParams[TestsCB.ItemIndex].Norma do                          //          //
          begin                                                                 //          //
            Result := 1;                                                        //          //
                                                                                //          //
            if Chip[Y,X].Value[TestsCB.ItemIndex] <> NotSpec then               //          //
            begin                                                               //          //
              if (Min = -NotSpec)  and (Max <> NotSpec) then                    //          //
                  if Chip[Y,X].Value[TestsCB.ItemIndex] > Max then Result := 0; //          //
                                                                                //          //
              if (Min <> -NotSpec) and (Max = NotSpec)  then                    //          //
                if Chip[Y,X].Value[TestsCB.ItemIndex] < Min then Result := 0;   //          //
                                                                                //          //
              if (Min <> -NotSpec) and (Max <> NotSpec) then                    //          //
                if (Chip[Y,X].Value[TestsCB.ItemIndex] < Min) or                //          //
                   (Chip[Y,X].Value[TestsCB.ItemIndex] > Max) then Result := 0; //          //
            end                                                                 //          //
            else Result := 0;                                                   //          //
          end;                                                                  //          //
      end;                                                                      //          //
...
begin                                                                                       //
  ...
  begin                                                                                     //
    for Y := 0 to Length(Chip)-1 do                                                         //
      ...
      begin                                                                                 //
        Res := GetStatus(Y, X);                                                             //
        if Res in [2, 3] then Inc(NFail);                                                   //
        if Res = 1 then Inc(NOKch);                                                         //
                                                                                            //
        Chip[Y, X].ShowGr := 0;                                                             //
                                                                                            //
        if ((OKP_Enabled) and (Res = 1)) or                                                 //
           ((FlP_Enabled) and (Res in [2, 3])) then                                         //
        begin                                                                               //
          rTmpSingle := Chip[Y, X].Value[TestsCB.ItemIndex];                                //
    ...
    begin                                                                                   //
      ...
      MedVal :=  0.0;                                                                       //
                                                                                            ...
                                                                                            //
  MinLab.Caption := FormatFloat('0.000', Groups.MinVal);                                    //
  AvrLab.Caption := FormatFloat('0.000', Groups.AvrVal);                                    //
  MedLab.Caption := FormatFloat('0.000', Groups.MedVal);                                    //
  MaxLab.Caption := FormatFloat('0.000', Groups.MaxVal);                                    //
    ...
    for n := 0 to Length(Groups.Group)-1 do                                           //
      ...
      begin                                                                           //
        case Status of                                                                //
          ...
          3: begin Col1 := clNavy;   Col2 := clBlue; end;                             //
        end;                                                                          //
                                                                                      //
        Pen.Color   := Col1;                                                          //
        Brush.Color := Col2;                                                          //
