          ...
          begin                                                                                           //
            ...
            if Res = 1 then                                                                               //
              with Chip[Y, X] do                                                                          //
                if FirstTimeOK then                                                                       //
                begin                                                                                     //
                  AddParams[n].OK.Min := Value[n];                                                        //
                  AddParams[n].OK.Max := Value[n];                                                        //
                  OKSum := Value[n];                                                                      //
                                                                                                          //
                  FirstTimeOK := False;                                                                   //
                end                                                                                       //
                ...
                begin                                                                                     //
                  if Value[n] < AddParams[n].OK.Min then AddParams[n].OK.Min := Value[n];                 //
                  if Value[n] > AddParams[n].OK.Max then AddParams[n].OK.Max := Value[n];                 //
                  OKSum := OKSum+Value[n];                                                                //
                end;                                                                                      //
                                                                                                          //
                                                                                                          //
            if Res in [2,3] then                                                                          //
              with Chip[Y, X] do                                                                          //
                ...
                begin                                                                                     //
                  AddParams[n].All.Min := Value[n];                                                       //
                  AddParams[n].All.Max := Value[n];                                                       //
                  FailSum := Value[n];                                                                    //
                  Inc(FailCount);                                                                         //
                                                                                                          //
                  FirstTimeFail := False;                                                                 //
                ...
                begin                                                                                     //
                  if Value[n] < AddParams[n].All.Min then AddParams[n].All.Min := Value[n];               //
                  if Value[n] > AddParams[n].All.Max then AddParams[n].All.Max := Value[n];               //
                  FailSum := FailSum+Value[n];                                                            //
                  Inc(FailCount);                                                                         //
                end;                                                                                      //
          end;                                                                                            //
                                                                                                          //
